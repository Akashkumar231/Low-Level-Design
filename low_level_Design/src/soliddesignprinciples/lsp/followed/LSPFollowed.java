package soliddesignprinciples.lsp.followed;

import java.util.ArrayList;
import java.util.List;

// 1. soliddesignprinciples.lsp.followed.DepositOnlyAccount interface: only allows deposits
interface DepositOnlyAccount {
    void deposit(double amount);
}

// 2. soliddesignprinciples.lsp.followed.WithdrawableAccount interface: allows deposits and withdrawals
